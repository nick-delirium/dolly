<!-- dolly plan · created 2026-08-07T19:27:59Z · @rjshrjndrn -->
# Plan — support pi as an install target
...
add a pi Target to src/install.ts so `dolly install` detects and wires dolly into the pi coding agent (~/.pi/agent): skills, commands, MCP server, and hooks if pi supports them
